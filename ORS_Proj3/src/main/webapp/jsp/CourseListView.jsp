...
<body>
<jsp:useBean id="dto" scope="request" class="in.co.rays.proj3.dto.CourseDTO" />
<div>
...
<form action="<%=ORSView.COURSE_LIST_CTL %>" method="post">  
            ...
            <td><input type="button" name="operation" value="<%=CourseListCtl.OP_BACK%>"> </td>
          <% }else{ %>
           <h3 class="text-center default-text text-light py-3"> Course List:</h3>
...
<%} %> 
      ...
      <th class="text-center"><input type="checkbox" id="select_all" name="select">Select All</th>
       ...
       <%
			...
			<td align="right"><input class="bg-primary text-white" style="font-size: 17px" type="submit"  name="operation" value="<%=CourseListCtl.OP_NEXT%>" <%=list.size()>=pagesize ? "" : "disabled"%>>
			</td>
