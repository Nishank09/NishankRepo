...
<%@page import="in.co.rays.proj3.model.CourseModelHBI"%>
...
<body>
	...
	<div class="container-fluid">
		<form action="<%=ORSView.SUBJECT_LIST_CTL%>" method="post">
			...
			<%
				List subjectlist = Serviletutility.getlist(request);
			...
			<div class="text-center">
				...
				%>
				<h3 class="text-center default-text text-light py-3">Subject
					List:</h3>
	...
	<%
			...
			%>
					...
					<div class=" row justify-content-center ">
						...
						<label class="form-check-label text-light" for="check2"
							style="width: 50px"> Course: </label>
						<div class="col-sm-2">
							<%=Htmlutility.getlist("Courseid", String.valueOf(dto.getCourseId()), courselist)%></div>
								...
								<tbody>
									<tr
										...
										<td><a class="text-dark"
											href="SubjectCtl?id=<%=dto.getId()%>">Edit</a></td>
									</tr>
								</tbody>
								<%
									}
						...
						<div class="table-responsive ">
							<table width="100%">
								<tr>
									<td><input class="bg-primary text-white"
										style="font-size: 17px" type="submit" name="operation"
										value="<%=SubjectListCtl.OP_PREVIOUS%>"
										<%=pageno > 1 ? "" : "disabled"%>></td>
									<td><input class="bg-success text-white"
										style="font-size: 17px" type="submit" name="operation"
										value="<%=SubjectListCtl.OP_NEW%>"></td>
									<td align="right"><input class="bg-danger text-white"
										style="font-size: 17px" type="submit" name="operation"
										value="<%=SubjectListCtl.OP_DELETE%>"></td>

									<td align="right"><input class="bg-primary text-white"
										style="font-size: 17px" type="submit" name="operation"
										value="<%=SubjectListCtl.OP_NEXT%>"
										<%=subjectlist.size() >= pagesize ? "" : "disabled"%>></td>
